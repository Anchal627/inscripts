...
function Row() {
  ...
  const handleClick = (message: unknown) => {
    setToastMessage(`You clicked ${message}`);
    setShowToast(true);
  };
    ...
    <>
      <div className="flex items-center w-full h-12 gap-2 border-b pt-[6px] pr-2 pb-[6px] pl-2 border-gray-200 bg-white">
        ...
        <div className="flex w-[871px] h-[36px] gap-1">
          <button
            className="flex w-[118px] h-[36px] gap-1 pt-2 pr-3 pb-2 pl-2 rounded-[6px] bg-white items-center hover:bg-gray-100"
          ...
          <button
            className="flex w-[73px] h-[36px] gap-1 pt-2 pr-3 pb-2 pl-2 rounded-[6px] bg-white items-center hover:bg-gray-100"
          ...
          <button
            className="flex w-[80px] h-[36px] gap-1 pt-2 pr-3 pb-2 pl-2 rounded-[6px] bg-white items-center hover:bg-gray-100"
          ...
          <button
            className="flex w-[105px] h-[36px] gap-1 pt-2 pr-3 pb-2 pl-2 rounded-[6px] bg-white items-center hover:bg-gray-100"
        ...
        <div className="w-[437px] h-[36px] gap-2  opacity-100 flex items-center ml-24">
          <button
            className="flex items-center w-[90px] h-[36px] bg-white gap-1 opacity-100 rounded-[6px] border border-solid border-[rgba(238,238,238,1)] pt-2 pr-3 pb-2 pl-2 hover:bg-gray-100"
          ...
          <button
            className="w-[89px] h-[36px] gap-1 opacity-100 rounded-[6px] border pt-2 pr-3 pb-2 pl-2 bg-white flex items-center border-[rgba(238,238,238,1)] hover:bg-gray-100"
          ...
          <button
            className=" w-[150px] h-[36px] gap-1 opacity-100 rounded-[6px] pt-2 pr-6 pb-2 pl-6 bg-[rgba(75,106,79,1)] flex items-center hover:bg-green-800"
      ...
      {showToast && (
        <div
          className="fixed top-8 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                        bg-green-300 text-black px-6 py-3 rounded shadow-lg z-50"
        >
          {toastMessage}
        </div>
      )}
